...
In the outer function, you should create a variable called answer which is the result of a
...
return "Your guess is too low!". You should stop the user from guessing if the amount of guesses
...
function guessingGame(amount){
    ...
    var game = guessingGame(5)
    console.log(game(1));   // to low
    console.log(game(5));   // to low
    console.log(game(9));   // to high
    console.log(game(7));   // to high
    console.log(game(6));   // you got it! , You are all done playing!
